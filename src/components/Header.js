  ...
  render() {
    return (
      <header
        ...
        className={
          "site-header " +
          _.get(this.props, "pageContext.site.siteMetadata.header.background")
        }
      >
                            ...
                            <li
                              ...
                              className={classNames("menu-item", {
                                "current-menu-item":
                                  ...
                                  _.get(action, "url"),
                                "menu-button":
                                  _.get(action, "type") === "button",
                              })}
                            >
                              <Link
                                className={classNames({
                                  button: _.get(action, "type") === "button",
                                })}
                        ...
                        {_.map(
                          ...
                          (action, action_idx) =>
                            action && (
                              ...
                              >
                                {_.get(action, "type") === "icon" &&
                                _.get(action, "icon_class") ? (
                                  <React.Fragment>
                                    <span
                                      className={
                                        "fab " + _.get(action, "icon_class")
                                      }
                                      aria-hidden="true"
                                    />
